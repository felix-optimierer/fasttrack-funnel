// EXIT-PLAN-TERMIN PAGE — Nach Opt-in auf /exit-plan: WhatsApp-Button + Calendly-Buchung.
...
export default function ExitPlanTermin() {
      ...
      >
        <section className="container pb-14 pt-2 text-center">
          ...
          <h1 className="mx-auto max-w-2xl text-balance text-2xl font-extrabold leading-[1.15] md:text-4xl">
            ...
            <span className="text-gradient-gold">Exit-Plan</span>{" "}
            gesichert.
          </h1>
          ...
          <div className="mt-4 mb-6 inline-flex items-center gap-2 rounded-full border border-gold/40 bg-card/70 px-4 py-2 text-xs font-semibold text-gold backdrop-blur md:text-sm">
            Klicke auf den Button und sende uns eine WhatsApp-Nachricht, um anschließend den Exit-Plan zu erhalten.
          </div>
          ...
          <div className="mb-12">
            ...
            >
              ...
              Jetzt Exit-Plan zugesendet bekommen
            </a>
          </div>
