// DANKE-EXIT-PLAN PAGE — Nach Opt-in: Wistia-Video + WhatsApp-Button + Button zu /termin
...
export default function DankeExitPlan() {
  ...
  useEffect(() => {
    ...
    embedScript.src = "https://fast.wistia.com/embed/gbgtl8rg7j.js";
  ...
  return (
    <>
    <SEO
      title="Herzlichen Glückwunsch – Exit-Plan gesichert | PhysioFreiheit"
      description="Du hast dir den 5-Schritte Exit-Plan gesichert. Schau dir die wichtige Videobotschaft von Robin an."
    />
      ...
      >
        <section className="container pb-14 pt-2 text-center">
          ...
          <h1 className="mx-auto max-w-3xl text-balance text-2xl font-extrabold leading-[1.15] md:text-4xl">
            ...
            <span className="text-gradient-gold">5-Schritte Exit-Plan</span>{" "}
            gesichert{" "}
          ...
          <div className="mt-5 mb-8 inline-flex items-center gap-2 rounded-xl border border-gold/40 bg-card/70 px-5 py-3 text-xs font-semibold text-gold/90 backdrop-blur md:text-sm max-w-2xl text-center leading-relaxed">
            Klicke auf den Button und sende uns eine WhatsApp-Nachricht, um anschließend den Exit-Plan zu erhalten und schaue dir unbedingt die kurze Nachricht von Robin an.
          </div>
          ...
          <div className="mb-10">
            ...
            >
              ...
              Jetzt Exit-Plan per WhatsApp erhalten
            </a>
          </div>
          ...
          <div className="mx-auto max-w-3xl mb-10">
            <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-2xl">
              ...
              <wistia-player media-id="gbgtl8rg7j" aspect="1.7777777777777777"></wistia-player>
            </div>
          </div>
